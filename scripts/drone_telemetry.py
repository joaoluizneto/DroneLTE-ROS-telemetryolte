...
class drone_telemetry:
        def __init__(self):
                self.api_url = 'http://127.0.0.1:8000/ros/'
                self.api_websocket_endpoint = 'robot/room/guy/'
                self.api_header = {"Authorization" : "Basic cG9zdG1hbjpwYXNzd29yZA=="}

                # Initializing ROS node.
                rospy.init_node("drone_telemetry_over_network")
                self.drone_gnc_api = gnc_api()
